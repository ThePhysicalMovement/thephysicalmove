        ...
        <div class="col-md-8 offset-md-2">
          ...
          <form action="" method="POST" onsubmit="return false;" novalidate>
            ...
            <div class="text-center">
              <input class="btn btn-primary btn-submit-form" type="submit" value="Send" onmouseover="$(this).addClass('animated pulse');" onmouseout="$(this).removeClass('animated pulse');" />
            </div>
